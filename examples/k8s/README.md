...
```bash
cd examples/k8s
docker build -t YOUR_REGISTRY/sheaf-chronos:v0.12.0 .
docker push YOUR_REGISTRY/sheaf-chronos:v0.12.0
```
...
In `rayservice.yaml`, replace `YOUR_REGISTRY/sheaf-chronos:v0.12.0` with
