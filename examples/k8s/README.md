...
```bash
cd examples/k8s
docker build -t YOUR_REGISTRY/sheaf-chronos:v0.12.1 .
docker push YOUR_REGISTRY/sheaf-chronos:v0.12.1
```
...
In `rayservice.yaml`, replace `YOUR_REGISTRY/sheaf-chronos:v0.12.1` with
